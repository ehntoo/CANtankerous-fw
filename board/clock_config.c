...
outputs:
- {id: CAN_clock.outFreq, value: 50 MHz}
...
- {id: SYSCON.CANCLKDIV.scale, value: '3', locked: true}
...
/*******************************************************************************
 * Variables for run configuration
 ******************************************************************************/
/*******************************************************************************
 * Code for run configuration
 ******************************************************************************/
void run(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCanClk, 3U, false);         /*!< Set CANCLKDIV divider to value 3 */
    ...
    SystemCoreClock = RUN_CORE_CLOCK;
#endif
}
